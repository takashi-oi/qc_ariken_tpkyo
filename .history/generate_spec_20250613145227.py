...
# 日本語フォントの設定（ヒラギノ角ゴシック ProN W3を使用）
FONT_PATH = '/System/Library/Fonts/ヒラギノ角ゴシック\ ProN\ W3.otf'
pdfmetrics.registerFont(TTFont('HiraginoProN', FONT_PATH))
