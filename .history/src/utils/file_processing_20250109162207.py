    ...
    async def _process_data(self,
        ...
        try:
            ...
            pc_columns = [
                ...
                'Measurer', 'Dye', 'Type', 'Lot Number', 'Sample Type',
                'Ct', 'CL', 'SD'
            ic_data = pd.DataFrame(columns=columns) if ic_data.empty else organize_data(ic_data, columns)
            nc_data = pd.DataFrame(columns=columns) if nc_data.empty else organize_data(nc_data, columns)
            pc_data = pd.DataFrame(columns=pc_columns) if pc_data.empty else organize_data(pc_data, pc_columns)
