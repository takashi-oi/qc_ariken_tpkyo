...
class QCDataProcessor:
    ...
    async def _process_data(self,
        ...
        try:
            ...
            processed_df = pd.concat([processed_df, qc_control_df], ignore_index=True)

            # 各タイプのデータを分離して処理
            ic_data = processed_df[processed_df['Sample Type'] ==
                                   'IC'].copy()
            ...
            if pc_data.empty:
                ...
                pc_data['sd_conversion'] = pc_data['Ct'].apply(
                    lambda x: 'Pass'
