    ...
    async def _process_data(self,
        ...
        try:
            ...
            if not ic_data.empty:
                ic_data = ic_data[['verdict', 'item_code', 'date', 'batch', 'model', 'measurer', 
                                 'Dye', 'Type', 'Lot number', 'Sample Type', 'Ct']]
                ic_data['Ct'] = pd.to_numeric(ic_data['Ct'], errors='coerce')
                ic_data = ic_data.astype({
                    'verdict': 'str',
                    'item_code': 'str', 
                    'date': 'str',
                    'batch': 'str',
            ...
            if not nc_data.empty:
                nc_data = nc_data[['verdict', 'item_code', 'date', 'batch', 'model', 'measurer',
                                 'Dye', 'Type', 'Lot number', 'Sample Type', 'Ct']]
                nc_data['Ct'] = pd.to_numeric(nc_data['Ct'], errors='coerce')
                nc_data = nc_data.astype({
                    'verdict': 'str',
                    'item_code': 'str',
                    'date': 'str',
                    'batch': 'str',
