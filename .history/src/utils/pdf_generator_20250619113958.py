from reportlab.lib.pagesizes import letter  # ページサイズを定義するためのモジュールをインポート
from reportlab.platypus import SimpleDocTemplate, Paragraph, Spacer, Table, TableStyle  # PDFドキュメントの構造を定義するためのモジュールをインポート
from reportlab.lib.styles import getSampleStyleSheet, ParagraphStyle  # スタイルを定義するためのモジュールをインポート
from reportlab.pdfbase import pdfmetrics  # PDFの基本設定を行うためのモジュールをインポート
