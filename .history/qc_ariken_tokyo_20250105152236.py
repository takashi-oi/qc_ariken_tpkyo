...
st.page_link("pages/pg01_qc_check.py", label="pg 01 :精度管理試料測定結果：確認")
st.page_link("pages/pg02_qc_act_log.py", label="pg 02 :精度管理試料測定結果：対応")
st.page_link("pages/pg03_Confirmation_of_accuracy_control_implementation_status.py", label="pg 03 :Confirmation_of_accuracy_control_implementation_status:")
