    ...
    def insert_qc_data(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            formatted_data = {
                ...
                "Measurer": data.get("implementor", ""),  # implementorをMeasurerに変更
...
def main():
    ...
    with tab2:
        ...
        if show_status_log:
            selected_file_name = st.session_state.get('sidebar_file_name',
                                                      None)
