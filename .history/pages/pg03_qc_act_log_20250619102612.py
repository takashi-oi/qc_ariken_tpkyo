...
def main():
    ...
    with tab1:
        ...
        with st.form("qc_data_form"):
            ...
            implementor_options = [""] + employee_code_df["Member's_Name"].tolist()
            if sidebar_implementor in employee_code_df["Member's_Name"].tolist():
                implementor_index = employee_code_df["Member's_Name"].tolist().index(sidebar_implementor) + 1
            else:
                implementor_index = 0
