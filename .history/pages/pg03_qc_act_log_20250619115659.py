...
def main():
    ...
    with tab2:
        ...
        # サイドバーで選択したファイル名でtable_qc_status_logからデータ抽出
        ...
        if selected_file_name:
            try:
                ...
                status_log_df = pd.read_sql_query(query, conn, params=(selected_file_name,))
                conn.close()
                st.markdown(f"#### 選択ファイルのステータスログ: {selected_file_name}")
