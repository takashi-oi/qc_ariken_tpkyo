...
class DatabaseManager:
    ...
    def save_check_log(self, check_log_df):
        ...
        try:
            ...
            # データ型の変換と検証
            check_log_df['date'] = pd.to_datetime(check_log_df['date']).dt.date
...
class QCCheckUI:
    ...
    def render_sidebar(self):
        ...
        with st.sidebar:
            ...
            return date, identifier, Measurer

    # チャートのレンダリング
    def render_charts(self, date, identifier, Measurer):
        """チャートのレンダリング"""
...
def main():
    ...
    try:
        ...
        # サイドバーのレンダリング
        date, identifier, Measurer = ui.render_sidebar()
        ...
        check_logs = ui.render_charts(date, identifier, Measurer)
