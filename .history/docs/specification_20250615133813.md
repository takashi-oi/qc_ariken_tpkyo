...
| `process_and_display()` | データの処理と表示 | uploaded_file: UploadedFile, measurer: str | ProcessedData |
...
| メソッド名 | 説明 | 引数 | 戻り値 |
|------------|------|------|--------|
| `save_qc_check()` | QCチェック結果をデータベースに保存 | start_date: str, end_date: str, measurement: str, measurer: str, check_logs: List[Dict[str, str]] | bool |
| `check_duplicate_records()` | 重複レコードのチェック | table: str, check_data: Dict[str, Any] | bool |
