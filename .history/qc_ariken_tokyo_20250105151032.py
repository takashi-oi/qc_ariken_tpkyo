...
st.markdown("#### メニュー")
st.markdown("##### pg 01 : mulch-rule setting:")
st.markdown("### ⭐️ルチルール設定:測定結果の確認")
st.markdown("##### pg 02 : qc act log:")
...
st.markdown("[ページ1: ルチルール設定](link_to_page1)")
st.markdown("[ページ2: 精度管理実施状況確認の登録](link_to_page2)")
st.markdown("[ページ3: QCチェックの実施](link_to_page3)")
st.markdown("[ページ4: 統計学的精度管理図作成](link_to_page4)")
