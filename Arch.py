...
st.page_link(
    "pages/pg01_qc_check.py", label="pg01 :管理試料測定結果登録：確認", icon="📈"
)

st.page_link("pages/pg02_test_status.py", label="pg02 : 測定状況登録", icon="✏️")

st.page_link(
    "pages/pg03_qc_act_log.py", label="pg03 :精度管理試料測定結果：対応", icon="✏️"
)
...
st.page_link("pages/pg05_statical.py", label="pg05 : 精度管理図出力:", icon="📈")

st.page_link(
    "pages/pg06_reagent_management.py", label="pg06 : 試薬管理システム", icon="🧪"
)
